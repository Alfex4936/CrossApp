...
<main>
  <ul id="menu">
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 1; updateNotice(1)}}>전체 공지</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 2; updateNotice(2)}}>학사</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 3; updateNotice(3)}}>비교과</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 4; updateNotice(4)}}>장학</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 5; updateNotice(5)}}>학술</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 6; updateNotice(6)}}>입학</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 7; updateNotice(7)}}>취업</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 8; updateNotice(8)}}>사무</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 9; updateNotice(9)}}>기타</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 10; updateNotice(10)}}>행사</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 11; updateNotice(11)}}>파란학기제</a
        >
    </li>
    |
    <li>
        <a
            class="category"
            href="/"
            on:click|preventDefault={() => {last_menu = 12; updateNotice(12)}}>학사일정</a
        >
    </li>
</ul>
  ...
  {:then weather}
    ...
    <p>
      아주대 현재 날씨 {weather.current_temp} ({weather.current_stat}), 최저
      기온은 {weather.min_temp}, 최고 기온은 {weather.max_temp}<br />
